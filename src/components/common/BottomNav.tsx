...
import { Home, Camera, BarChart3, User, Settings } from "lucide-react"; // Promijeni Users u User
...
export function BottomNav() {
  ...
  const navItems = [
    ...
    { screen: "profile" as Screen, icon: User, label: "Nalog" },
  ];
        ...
        {navItems.map(({ screen, icon: Icon, label }) => (
          <button
            ...
            className={`bottom-nav-item ${
              currentScreen === screen ? "active" : "inactive"
            }`}
          >
